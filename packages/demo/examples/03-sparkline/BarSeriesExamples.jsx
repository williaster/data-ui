...
export default [
  {
    ...
    components: [Sparkline, BarSeries],
    example: () => (
      <Spacer top={2} left={2} flexDirection="column">
        <Example title="Default">
          <Sparkline {...sparklineProps} data={randomData(50)}>
            <BarSeries />
          </Sparkline>
        </Example>
        ...
        <Example title="Gradient fill with vertical reference line">
          <Sparkline {...sparklineProps} data={randomData(30)}>
            <LinearGradient id="bar_gradient" to={allColors.yellow[1]} from={allColors.yellow[8]} />
            <VerticalReferenceLine
              reference={24}
            ...
            />
            <BarSeries fill="url(#bar_gradient)" fillOpacity={(d, i) => (i === 24 ? 1 : 0.5)} />
          </Sparkline>
        </Example>
        ...
        <Example title="Pattern fill with vertical reference line">
          <Sparkline {...sparklineProps} data={randomData(20)}>
            <PatternLines
              id="bar_pattern"
              height={4}
              width={4}
