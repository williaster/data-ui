...
describe('getScaleForAccessor', () => {
  ...
  it('should compute date domains', () => {
    expect(
      getScaleForAccessor({
        allData,
    ...
    ).toEqual([new Date(allData[0].date), new Date(allData[allData.length - 1].date)]);
  });

  it('should compute date strings domains', () => {
    expect(
      getScaleForAccessor({
        allData,
    ...
    ).toEqual(['2016-01-05', '2017-01-05', '2018-01-05', '2019-01-05']);
  });

  it('should compute categorical domains', () => {
    expect(
      getScaleForAccessor({
        allData,
        minAccessor: d => d.cat,
  ...
  it('should compute numeric domains including zero', () => {
    expect(
      getScaleForAccessor({
        allData,
        minAccessor: d => d.num,
  ...
  it('should compute numeric domains excluding zero', () => {
    expect(
      getScaleForAccessor({
        allData,
        minAccessor: d => d.num,
  ...
  it('should compute numeric domains with missing values', () => {
    expect(
      getScaleForAccessor({
        allData,
