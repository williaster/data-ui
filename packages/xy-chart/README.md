...
```javascript
import { XYPlot, BarSeries, CrossHairs, XAxis, YAxis, LinearGradient } from '@data-ui/xy-chart';
...
/// ...
  ...
  >
    ...
    />
    <CrossHairs showHorizontalLine={false} fullHeight stroke="pink" />
  </XYChart>
```
...
children | PropTypes.node | - | Any node; axes, crosshairs, and series children are cloned with additional props such as scales.
